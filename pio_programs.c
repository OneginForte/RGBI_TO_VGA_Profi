...
uint16_t pio_capture_0_instructions[] = {
    //             .wrap_target
...
const struct pio_program pio_capture_0 = {
    .instructions = pio_capture_0_instructions,
    .length = 17,
    .origin = -1,
};
...
uint16_t pio_capture_1_instructions[] = {
    //                         .wrap_target
...
const struct pio_program pio_capture_1 = {
    .instructions = pio_capture_1_instructions,
    .length = 16,
    .origin = -1,
};
