...
void __SetupUSBDescriptor() {
    if (!usbd_desc_cfg) {
        ...
        uint8_t tud_cfg_desc[TUD_CONFIG_DESC_LEN] = {
            ...
            TUD_CONFIG_DESCRIPTOR(1, interface_count, USBD_STR_0, usbd_desc_len, TUSB_DESC_CONFIG_ATT_REMOTE_WAKEUP, 500/*USBD_MAX_POWER_MA*/)
        };
